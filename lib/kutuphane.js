...
function kuyruk(ops = {}) {
  const atla = new Set([...jsonOku(path.join(KOK, "icerik", "uretilenler.json"), []), ...jsonOku(path.join(KOK, "icerik", "basarisiz.json"), []),
...
module.exports = { YOL, KUMELER, kumeBul, konuOku, konular, kuyruk, uretimKonusu, yayinlananlar, yayinKaydet, yayinBul,
