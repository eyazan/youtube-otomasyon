...
const RUH = {
  "bridge-failures": { oranlar: [1.5, 1.335], trem: [0.09, 0.14], renk: "brown", ton: "tense" },
  "structural-failures": { oranlar: [1.5, 1.2], trem: [0.10, 0.16], renk: "pink", ton: "tense" },
  ...
  "maritime-disasters": { oranlar: [1.2, 1.5], trem: [0.06, 0.1], renk: "brown", ton: "deep" },
  "nuclear-accidents": { oranlar: [1.414, 1.189], trem: [0.07, 0.11], renk: "brown", ton: "ominous" },
  "fire-and-explosions": { oranlar: [1.5, 1.26], trem: [0.14, 0.22], renk: "pink", ton: "urgent" },
  "industrial-disasters": { oranlar: [1.335, 1.189], trem: [0.1, 0.15], renk: "brown", ton: "heavy" },
  "infrastructure-failures": { oranlar: [1.5, 1.335], trem: [0.08, 0.13], renk: "pink", ton: "tense" },
  "materials-failures": { oranlar: [1.26, 1.5], trem: [0.05, 0.09], renk: "pink", ton: "slow" },
  "natural-hazards": { oranlar: [1.5, 1.2], trem: [0.08, 0.18], renk: "brown", ton: "vast" },
};
...
function profil(slug, kume) {
  ...
  const trem = Math.round((r.trem[0] + h("trem") * (r.trem[1] - r.trem[0])) * 1000) / 1000;
